...
Datas ar extracted and some works, like obtaining the relative abundance, are done.

## Initialistion of the loop.

A loop, which will get each file, extract the needed datas, and get the relative abundance is used.
...
This loop is going to gather each files to get the information contained in each of them, and treat these informations.
...
Some more treatments are done on the data to calculate the relative abundance and to prepare them for the heatmap,
