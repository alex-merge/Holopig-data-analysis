...
```{r}
rm(list = c("functions_interest_final_dataframe","functions_name_corresp", "reshaped_functions", "reshaped_functions_no_unknown", "reshaped_functions_pig", "function_interest", "my_breaks", "scale", "functions_interest_final_dataframe_ordered"))
```
