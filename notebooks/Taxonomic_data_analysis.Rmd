...
#filtered_data[,2] = sum(filtered_data[,2], 0.00001)
filtered_data$abond = 0.0001 + as.numeric(filtered_data$abond)
head(filtered_data)
```
...
ggplot(filtered_data, aes(ind, filtered_data[,2], fill= abond)) + 
 ...
 scale_fill_gradientn(name = "count",
                    ...
                    breaks = my_breaks, 
                    labels = my_breaks,
                    colours = c("#408DBB",  "#D0EC97","#FFFFBF", "#FD945D", "#DC4E51", "#A30909", "#370303","#000000"),
 )+
...
#paste("../export/HM_taxonomy_",taxo_level,".png", sep="")

#ggsave(filename = "../export/HM_taxonomy_",taxo_level,".png",
ggsave(filename = paste("../export/HM_taxonomy_",taxo_level,"1.png", sep=""),
       width = 16*scale,
       height = 18*scale,
       units = "px",
       dpi=200)
