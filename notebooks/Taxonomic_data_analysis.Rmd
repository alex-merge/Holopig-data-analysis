...
filtered_data = aggregate(. ~  kingdom + tax + piglet + group, data = filtered_data, sum)
...
```{r}
#ENTER VALUE 
taxo_level = "genus"    #possible options : kingdom	- phylum -	class	- order -	familly -	genus -	species
```
...
ggplot(filtered_data, aes(abund, filtered_data[,2], fill = group)) + 
  ...
  theme(line = element_blank(),
        ...
        panel.grid.major.y = element_line(size = 5, linetype = 'solid', colour = "grey"),
