...
```{r}
abundance_df_unnormalized = abundance_df
abundance_df[9:42] = scale(abundance_df[9:42])
```
...
category = c("Controle", "Colistine", "Controle", "Controle", "Controle", "Controle",
...
write.table(final_df, 
            file = "../refined_data/complete_taxonomic_abondance.csv",
            col.names = TRUE,
            row.names = FALSE,
            sep=";")

write.table(abundance_df_unnormalized, 
